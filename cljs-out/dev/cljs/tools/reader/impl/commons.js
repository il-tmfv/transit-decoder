...
var G__13501 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__13501;
continue;
} else {
return ch;
...
var vec__13502 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13502,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq13505){
...
return (function() { 
var G__13510__delegate = function (rdr,_){
...
var G__13510 = function (rdr,var_args){
var _ = null;
...
while (G__13511__i < G__13511__a.length) {G__13511__a[G__13511__i] = arguments[G__13511__i + 1]; ++G__13511__i;}
  _ = new cljs.core.IndexedSeq(G__13511__a,0,null);
} 
return G__13510__delegate.call(this,rdr,_);};
G__13510.cljs$lang$maxFixedArity = 1;
G__13510.cljs$lang$applyTo = (function (arglist__13512){
var rdr = cljs.core.first(arglist__13512);
var _ = cljs.core.rest(arglist__13512);
return G__13510__delegate(rdr,_);
});
