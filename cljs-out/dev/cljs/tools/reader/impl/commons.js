...
var G__14783 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__14783;
continue;
} else {
return ch;
...
var vec__14784 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14784,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq14787){
...
return (function() { 
var G__14792__delegate = function (rdr,_){
...
var G__14792 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__14793__i = 0, G__14793__a = new Array(arguments.length -  1);
while (G__14793__i < G__14793__a.length) {G__14793__a[G__14793__i] = arguments[G__14793__i + 1]; ++G__14793__i;}
  _ = new cljs.core.IndexedSeq(G__14793__a,0,null);
} 
return G__14792__delegate.call(this,rdr,_);};
G__14792.cljs$lang$maxFixedArity = 1;
G__14792.cljs$lang$applyTo = (function (arglist__14794){
var rdr = cljs.core.first(arglist__14794);
var _ = cljs.core.rest(arglist__14794);
return G__14792__delegate(rdr,_);
});
