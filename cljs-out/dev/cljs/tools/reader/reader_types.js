...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13789 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13789(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13790 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13790(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13791 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13791(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13792 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13792(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13793 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13793(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13794 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13794(reader);
}
});
...
var G__13805 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13806 = s.append(c);
c = G__13805;
s = G__13806;
continue;
}
