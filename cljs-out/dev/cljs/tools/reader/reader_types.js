...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13230 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13230(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13231 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13231(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13232 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13232(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13233 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13233(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13234 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13234(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13235 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13235(reader);
}
});
...
var G__13246 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13247 = s.append(c);
c = G__13246;
s = G__13247;
continue;
}
