...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13166 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13166(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13167 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13167(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13168 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13168(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13169 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13169(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13170 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13170(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13171 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13171(reader);
}
});
...
var G__13182 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13183 = s.append(c);
c = G__13182;
s = G__13183;
continue;
}
