...
if((i < len)){
var k = (ks[i]);
var G__16955 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__16956 = (i + (1));
m = G__16955;
i = G__16956;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__16957 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__16957) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__16957));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__16959 = c;
var G__16959__$1 = (((G__16959 == null))?null:G__16959.prototype);
if((G__16959__$1 == null)){
return null;
} else {
return (G__16959__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__16961 = c;
var G__16961__$1 = (((G__16961 == null))?null:G__16961.prototype);
if((G__16961__$1 == null)){
return null;
} else {
return (G__16961__$1["render"]);
}
})() == null)))));
});
...
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__16963) : reagent.impl.component.as_element.call(null,G__16963));
};
...
while (G__16966__i < G__16966__a.length) {G__16966__a[G__16966__i] = arguments[G__16966__i + 0]; ++G__16966__i;}
  args = new cljs.core.IndexedSeq(G__16966__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__16969 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__16970 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__16970;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__16969;
}});
...
return ((function (G__16971,G__16971__$1){
...
var c = this;
var G__16976_16978 = (c["cljsRatom"]);
if((G__16976_16978 == null)){
} else {
reagent.ratom.dispose_BANG_(G__16976_16978);
}
...
var renders_16980 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_16981 = cljs.core.first(cljs.core.vals(renders_16980));
if((cljs.core.count(renders_16980) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_16980))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_16981)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_16981], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__16979 = name;
switch (G__16979) {
case "":
...
var G__16984 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__16984) : reagent.impl.component.global$module$create_react_class.call(null,G__16984));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__16985 = fiber;
var G__16985__$1 = (((G__16985 == null))?null:(G__16985["type"]));
if((G__16985__$1 == null)){
return null;
} else {
return (G__16985__$1["displayName"]);
}
})();
var parent = (function (){var G__16986 = fiber;
if((G__16986 == null)){
return null;
} else {
return (G__16986["return"]);
}
})();
var path = (function (){var G__16987 = parent;
var G__16987__$1 = (((G__16987 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__16987) : reagent.impl.component.fiber_component_path.call(null,G__16987)));
if((G__16987__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16987__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4131__auto__ = (function (){var G__16989 = c;
if((G__16989 == null)){
return null;
} else {
return (G__16989["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__16990._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__16992 = c;
if((G__16992 == null)){
return null;
} else {
return (G__16992["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__16994 = c;
if((G__16994 == null)){
return null;
} else {
return G__16994._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__16996 = instance;
if((G__16996 == null)){
return null;
} else {
return (G__16996["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__16997 = instance;
if((G__16997 == null)){
return null;
} else {
return G__16997._currentElement;
}
}
})();
var name = (function (){var G__16998 = elem;
var G__16998__$1 = (((G__16998 == null))?null:(G__16998["type"]));
if((G__16998__$1 == null)){
return null;
} else {
return (G__16998__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__17000 = elem;
if((G__17000 == null)){
return null;
} else {
return (G__17000["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__17001._owner;
}
}
})();
var path = (function (){var G__17002 = owner;
var G__17002__$1 = (((G__17002 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__17002) : reagent.impl.component.component_path.call(null,G__17002)));
if((G__17002__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17002__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__17003 = c;
var G__17003__$1 = (((G__17003 == null))?null:G__17003.constructor);
if((G__17003__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__17003__$1);
}
}
})();
