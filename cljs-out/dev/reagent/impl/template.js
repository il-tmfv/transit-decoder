...
var G__17006 = o;
(G__17006[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__17010 = o;
(G__17010[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__17011__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__17012__i < G__17012__a.length) {G__17012__a[G__17012__i] = arguments[G__17012__i + 0]; ++G__17012__i;}
  args = new cljs.core.IndexedSeq(G__17012__a,0,null);
} 
return G__17011__delegate.call(this,args);};
G__17011.cljs$lang$maxFixedArity = 0;
G__17011.cljs$lang$applyTo = (function (arglist__17013){
var args = cljs.core.seq(arglist__17013);
return G__17011__delegate(args);
});
...
var G__17015 = props;
var G__17015__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17015,cljs.core.cst$kw$id,id):G__17015);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17015__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__17016){
...
var props = map__17017__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17017__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__17017,map__17017__$1,props,class$){
return (function (c){
...
});})(map__17017,map__17017__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__17019){
var map__17020 = p__17019;
var map__17020__$1 = (((((!((map__17020 == null))))?(((((map__17020.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__17020.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__17020):map__17020);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17020__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__17020,map__17020__$1,on_write){
return (function (){
...
});})(node_value,map__17020,map__17020__$1,on_write))
);
} else {
...
var G__17023 = jsprops;
(G__17023["defaultValue"] = value);

(G__17023["onChange"] = ((function (G__17023,v,value,on_change){
return (function (p1__17022_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17022_SHARP_);
});})(G__17023,v,value,on_change))
);
...
var vec__17026 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17026,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17026,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17026,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___17030 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___17030 == null)){
} else {
var key_17031 = temp__5461__auto___17030;
(jsprops["key"] = key_17031);
}
...
var temp__5461__auto___17032 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___17032 == null)){
} else {
var key_17033 = temp__5461__auto___17032;
reagent.impl.template.oset(jsprops,"key",key_17033);
}
...
var G__17034 = reagent.impl.template.__GT_NativeWrapper();
(G__17034["name"] = c);
...
var G__17035 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__17035) : reagent.impl.template.as_element.call(null,G__17035));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17039){
...
var n__4607__auto___17048 = a.length;
var i_17049 = (0);
while(true){
if((i_17049 < n__4607__auto___17048)){
(a[i_17049] = reagent.impl.template.as_element((a[i_17049])));

var G__17050 = (i_17049 + (1));
i_17049 = G__17050;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___17051 = a.length;
var i_17052 = (0);
while(true){
if((i_17052 < n__4607__auto___17051)){
var val_17053 = (a[i_17052]);
if(((cljs.core.vector_QMARK_(val_17053)) && ((reagent.impl.template.key_from_vec(val_17053) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_17052] = reagent.impl.template.as_element(val_17053));
...
var ctx = ({});
var vec__17055 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17055,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17055,(1),null);
...
var G__17058 = (cljs.core.count(argv) - first_child);
switch (G__17058) {
case (0):
...
case (1):
var G__17059 = comp;
var G__17060 = jsprops;
var G__17061 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__17059,G__17060,G__17061) : reagent.impl.template.global$module$react.createElement.call(null,G__17059,G__17060,G__17061));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__17058){
