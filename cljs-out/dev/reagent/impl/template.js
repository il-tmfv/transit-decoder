...
var G__18622 = o;
(G__18622[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__18626 = o;
(G__18626[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__18627__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__18627__delegate.call(this,args);};
...
return G__18627__delegate(args);
});
...
var G__18631 = props;
var G__18631__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18631,cljs.core.cst$kw$id,id):G__18631);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18631__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__18632){
...
var props = map__18633__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18633__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__18633,map__18633__$1,props,class$){
return (function (c){
...
});})(map__18633,map__18633__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__18635){
var map__18636 = p__18635;
var map__18636__$1 = (((((!((map__18636 == null))))?(((((map__18636.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__18636.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__18636):map__18636);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18636__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__18636,map__18636__$1,on_write){
return (function (){
...
});})(node_value,map__18636,map__18636__$1,on_write))
);
} else {
...
var G__18639 = jsprops;
(G__18639["defaultValue"] = value);

(G__18639["onChange"] = ((function (G__18639,v,value,on_change){
return (function (p1__18638_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__18638_SHARP_);
});})(G__18639,v,value,on_change))
);
...
var vec__18642 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18642,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18642,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18642,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___18646 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___18646 == null)){
} else {
var key_18647 = temp__5461__auto___18646;
(jsprops["key"] = key_18647);
}
...
var temp__5461__auto___18648 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___18648 == null)){
} else {
var key_18649 = temp__5461__auto___18648;
reagent.impl.template.oset(jsprops,"key",key_18649);
}
...
var G__18650 = reagent.impl.template.__GT_NativeWrapper();
(G__18650["name"] = c);
...
var G__18651 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__18651) : reagent.impl.template.as_element.call(null,G__18651));
} else {
...
args__4736__auto__.push((arguments[i__4731__auto___18658]));
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq18655){
var G__18656 = cljs.core.first(seq18655);
var seq18655__$1 = cljs.core.next(seq18655);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18656,seq18655__$1);
});
...
break;
default:
var G__18662 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__18662;
continue;
...
var n__4607__auto___18664 = a.length;
var i_18665 = (0);
while(true){
if((i_18665 < n__4607__auto___18664)){
(a[i_18665] = reagent.impl.template.as_element((a[i_18665])));

var G__18666 = (i_18665 + (1));
i_18665 = G__18666;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___18667 = a.length;
var i_18668 = (0);
while(true){
if((i_18668 < n__4607__auto___18667)){
var val_18669 = (a[i_18668]);
if(((cljs.core.vector_QMARK_(val_18669)) && ((reagent.impl.template.key_from_vec(val_18669) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_18668] = reagent.impl.template.as_element(val_18669));

var G__18670 = (i_18668 + (1));
i_18668 = G__18670;
continue;
} else {
}
...
var ctx = ({});
var vec__18671 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18671,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18671,(1),null);
...
var G__18674 = (cljs.core.count(argv) - first_child);
switch (G__18674) {
case (0):
...
case (1):
var G__18675 = comp;
var G__18676 = jsprops;
var G__18677 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__18675,G__18676,G__18677) : reagent.impl.template.global$module$react.createElement.call(null,G__18675,G__18676,G__18677));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__18674){
