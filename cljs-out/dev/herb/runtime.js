 ...
 */
herb.runtime.update_state = (function herb$runtime$update_state(state,ident,p__14873,css){
var map__14874 = p__14873;
var map__14874__$1 = cljs.core.__destructure_map(map__14874);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14874__$1,cljs.core.cst$kw$data);
var data_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14874__$1,cljs.core.cst$kw$data_DASH_string);
var element = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14874__$1,cljs.core.cst$kw$element);
...
var style = (function (){var vec__14875 = cljs.core.cst$kw$data.cljs$core$IFn$_invoke$arity$1(new$);
var classname = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14875,(0),null);
var map__14878 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14875,(1),null);
var map__14878__$1 = cljs.core.__destructure_map(map__14878);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14878__$1,cljs.core.cst$kw$style);
var pseudo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14878__$1,cljs.core.cst$kw$pseudo);
var media = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14878__$1,cljs.core.cst$kw$media);
var supports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14878__$1,cljs.core.cst$kw$supports);
var prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14878__$1,cljs.core.cst$kw$prefix);
var vendors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14878__$1,cljs.core.cst$kw$vendors);
var combinators = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14878__$1,cljs.core.cst$kw$combinators);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [classname,cljs.core.with_meta(style,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$prefix,prefix,cljs.core.cst$kw$vendors,vendors], null)),pseudo,media,supports], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__14879){
var vec__14880 = p__14879;
var vec__14883 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14880,(0),null);
var seq__14884 = cljs.core.seq(vec__14883);
var first__14885 = cljs.core.first(seq__14884);
var seq__14884__$1 = cljs.core.next(seq__14884);
var combinator = first__14885;
var elements = seq__14884__$1;
var style__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14880,(1),null);
...
goog.dom.appendChild(cljs.core.cst$kw$element.cljs$core$IFn$_invoke$arity$1(new$),goog.dom.createTextNode(css_str));
...
var element = goog.dom.createElement("style");
goog.object.set(element,"type","text/css");
...
goog.dom.appendChild(head,element);
...
return herb.runtime.render_style_BANG_(identifier,(function (){var G__14886 = new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$data,new$,cljs.core.cst$kw$element,element], null);
if(cljs.core.truth_(data_str)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__14886,cljs.core.cst$kw$data_DASH_string,data_str);
} else {
return G__14886;
}
})());
...
var len__4818__auto___14891 = arguments.length;
var i__4819__auto___14892 = (0);
while(true){
if((i__4819__auto___14892 < len__4818__auto___14891)){
args__4824__auto__.push((arguments[i__4819__auto___14892]));

var G__14893 = (i__4819__auto___14892 + (1));
i__4819__auto___14892 = G__14893;
continue;
} else {
}
break;
...
var state = (function (){var G__14890 = dispatch;
...
var element_14895 = (function (){var or__4212__auto__ = document.querySelector(["style[data-herb=\"",cljs.core.name(dispatch),"\"]"].join(''));
...
var inner_html_14896 = goog.object.get(element_14895,"innerHTML");
goog.object.set(element_14895,"innerHTML",[cljs.core.str.cljs$core$IFn$_invoke$arity$1(inner_html_14896),((herb.runtime.dev_QMARK_)?"\n":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(css_str)].join(''));
...
/** @this {Function} */
(herb.runtime.inject_obj_BANG_.cljs$lang$applyTo = (function (seq14887){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14888,G__14889,seq14887__$2);
}));
